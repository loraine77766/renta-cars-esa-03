        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="tel:+15878569144" className="flex items-center gap-2 text-sm text-gray-400 hover:text-primary transition-colors">
                <Phone className="h-4 w-4" />
                +1 (587) 856-9144
              </a>
              <a href="https://wa.me/15878569144" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-gray-400 hover:text-primary transition-colors">
