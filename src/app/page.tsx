      ...
      <main>
        <section className="hero-gradient text-white">
          <div className="container mx-auto px-4 py-24 md:py-32 text-center">
            <div className="inline-block bg-white/15 px-5 py-2 rounded-full mb-6 text-sm font-medium">Cuba te espera</div>
        ...
        <section id="como-funciona" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-accent/70 text-center text-sm font-medium uppercase tracking-widest mb-12">5 pasos sencillos</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
               {howToSteps.map((step, index) => (
                   <div key={index} className="relative text-center group">
                       <div className="mx-auto bg-gradient-to-br from-primary to-accent text-white rounded-2xl h-20 w-20 flex items-center justify-center mb-4 shadow-md group-hover:shadow-lg group-hover:scale-105 transition-all duration-300">
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-accent/70 text-sm font-medium uppercase tracking-widest text-center mb-12">Nuestra promesa</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={i} className="text-center border border-border shadow-sm hover:shadow-md transition-all duration-300 rounded-2xl">
                  <CardHeader>
                    <div className="mx-auto bg-gradient-to-br from-primary/10 to-accent/10 rounded-2xl h-20 w-20 flex items-center justify-center mb-2">
